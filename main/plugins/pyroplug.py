        ...
        try:
           ...
           # medi =  msg.document or msg.video or msg.audio or None
            ...
            file = await userbot.download_media(
                ...
                progress_args=(
                    client,
                    "**__Unrestricting__: __[Deadpool](https://t.me/+DGQfhgy65yxhYWU1)__**\n ",
                    edit,
                    time.time()
                )
            )  
            ...
            if str(file).split(".")[-1] in ['mkv', 'mp4', 'webm', 'mpe4', 'mpeg', 'ts', 'avi', 'flv', 'org']:
                ...
                caption = f"{msg.caption}\n\n__Unrestricted by **[Deadpool](https://t.me/+DGQfhgy65yxhYWU1)**__" if msg.caption else "__Unrestricted by **[Deadpool](https://t.me/+DGQfhgy65yxhYWU1)**__"
                await client.send_video(
                    ...
                    progress_args=(
                        client,
                        '**__Uploading: [Deadpool](https://t.me/+DGQfhgy65yxhYWU1)__**\n ',
                        upm,
                        time.time()
                    )
                )
                ...
                await client.send_document(
                    ...
                    progress_args=(
                        client,
                        '**__Uploading:__**\n**__Bot made by [Deadpool](https://t.me/+DGQfhgy65yxhYWU1)__**',
                        upm,
                        time.time()
                    )
                )
